...
Our game is made in Phaser. Phaser is a HTML5 Game Engine, built to create
games using WebGL/canvas. Because you write Phaser code in Javascript,
everyone with a modern browser can play our game by just visiting the web
page. There is no need to download or install anything.

Also, since it all was written in Javascript, it was very easy for most of the
team to collaborate on the code. Javascript is used by a lot of people, and
all it's quirks are documented very well. So it is very easy for everyone to
...
\todo{add some programming iterations}
\\
\begin{figure}[h]
...
\todo{image of repository explorer}
